...
PERMS['aulas:asistencia'] = '> Asistencia';
PAGES.aulas = {
  //navcss: "btn1",
  Title: 'Gest. Aula',
    ...
    container.innerHTML = html`
      ...
      <div>
        ...
        <fieldset style="float: left;">
          ...
          <a class="button btn9" style="font-size: 25px;" href="#aulas,asistencia">
            Asistencia
          </a>
        </fieldset>
      </div>
...
Cargando...</pre
  ...
  _asistencia: function () {
    if (!checkRole('aulas:asistencia')) {
      setUrlHash('index');
      return;
    }
    ...
    if (!item) {
      ...
      switch (section) {
        ...
        case 'puntos_interes':
          ...
          break;
        case 'asistencia':
          // this._asistencia__edit(item);
          alert('No hay una vista de edición para asistencia, accede a ella desde el listado');
          break;
      }
    }
  },
